if &background == 'dark'
  let s:guishade0 = "#cc9393"
  let s:guishade1 = "#ffd7a7"
  let s:guishade2 = "#8f8f8f"
  let s:guishade3 = "#dfe4cf"
  let s:guishade4 = "#ecb3b3"
  let s:guishade5 = "#8cb0d3"
  let s:guishade6 = "#71d3b4"
  let s:guishade7 = "#ffcfaf"
  let s:guiaccent0 = "#1f1f1f"
  let s:guiaccent1 = "#5f7f5f"
  let s:guiaccent2 = "#8cb0d3"
  let s:guiaccent3 = "#71d3b4"
  let s:guiaccent4 = "#6f6f6f"
  let s:guiaccent5 = "#ffd7a7"
  let s:guiaccent6 = "#8f8f8f"
  let s:guiaccent7 = "#dfe4cf"
  let s:ctermshade0 = 181
  let s:ctermshade1 = 223
  let s:ctermshade2 = 245
  let s:ctermshade3 = 188
  let s:ctermshade4 = 224
  let s:ctermshade5 = 146
  let s:ctermshade6 = 116
  let s:ctermshade7 = 223
  let s:ctermaccent0 = 234
  let s:ctermaccent1 = 102
  let s:ctermaccent2 = 146
  let s:ctermaccent3 = 116
  let s:ctermaccent4 = 242
  let s:ctermaccent5 = 223
  let s:ctermaccent6 = 245
  let s:ctermaccent7 = 188
endif

highlight clear
syntax reset
let g:colors_name = "ThemerZenburn2"
