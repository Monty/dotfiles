if &background == 'dark'
  let s:guishade0 = "#1f1f1f"
  let s:guishade1 = "#5f7f5f"
  let s:guishade2 = "#8cb0d3"
  let s:guishade3 = "#71d3b4"
  let s:guishade4 = "#6f6f6f"
  let s:guishade5 = "#ffd7a7"
  let s:guishade6 = "#8f8f8f"
  let s:guishade7 = "#dfe4cf"
  let s:guiaccent0 = "#cc9393"
  let s:guiaccent1 = "#ffd7a7"
  let s:guiaccent2 = "#8f8f8f"
  let s:guiaccent3 = "#dfe4cf"
  let s:guiaccent4 = "#ecb3b3"
  let s:guiaccent5 = "#8cb0d3"
  let s:guiaccent6 = "#71d3b4"
  let s:guiaccent7 = "#ffcfaf"
  let s:ctermshade0 = 234
  let s:ctermshade1 = 102
  let s:ctermshade2 = 146
  let s:ctermshade3 = 116
  let s:ctermshade4 = 242
  let s:ctermshade5 = 223
  let s:ctermshade6 = 245
  let s:ctermshade7 = 188
  let s:ctermaccent0 = 181
  let s:ctermaccent1 = 223
  let s:ctermaccent2 = 245
  let s:ctermaccent3 = 188
  let s:ctermaccent4 = 224
  let s:ctermaccent5 = 146
  let s:ctermaccent6 = 116
  let s:ctermaccent7 = 223
endif

highlight clear
syntax reset
let g:colors_name = "ThemerZenburn1"
